...
const example = process(`r, wr, b, g, bwu, rb, gb, br
...
it("should pass challenge", () => {
	expect(TimeUtils.log(() => func(challenge))).toBe(642535800868438);
});
